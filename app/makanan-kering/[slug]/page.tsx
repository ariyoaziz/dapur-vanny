...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
    ...
    return {
        title: `${product.name} | Makanan Kering Dapur Vanny`,
        description: `Beli ${product.name} secara online. ${product.desc} Gratis pengiriman jangkauan seluruh Indonesia!`,
        openGraph: {
            title: `${product.name} | Makanan Kering Dapur Vanny`,
            description: `Beli ${product.name} secara online. ${product.desc}`,
            images: [
                {
